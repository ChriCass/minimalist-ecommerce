<template>
  <section class="container px-4 px-md-0 mt-5">
    <div class="row justify-content-center">
      ...
      <div
        ...
        v-for="p in limitedProducts"
        :key="p.id"
        @click="redirectToProduct(p.id)"
      >
...
export default {
  ...
  methods: {
    ...
    redirectToProduct(productId) {
      this.$router.push({ name: "single-product", params: { id: productId } });
    },
  },
  mounted() {
